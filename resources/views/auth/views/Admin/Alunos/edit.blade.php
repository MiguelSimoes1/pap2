            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Editar aluno</h6>
                    </div>
                    <form method="POST" action="{{route('alunodb.update', $aluno->id)}}">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nº de processo</label>
                            <input type="number" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" min="10000" max="50000" name="numProcesso"
                                value="{{$aluno->numProcesso}}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="exampleInputPassword1" min="1" max="99"
                                name="idade" value="{{$aluno->idade}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Email</label>
                            <input type="email" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="email" value="{{$aluno->email}}">
                        </div>
                        <a href=""><button type="submit" class="btn btn-primary btn-sm"> Alterar </button></a>
                    </form>
                    <br>
                    <a href="{{route('alunodb.index')}}"><button type="submit"
