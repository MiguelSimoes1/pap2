        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('profatividades.index')}}" class="nav-item nav-link active"></i>Atividades dos
                        professores</a>
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                @forelse ($atividadeprofessores as $atividadeprofessor)
                                <tr>
                                    <td>{{$atividadeprofessor->id}}</td>
                                    <td>{{$atividadeprofessor->nome}}</td>
                                    <td>{{$atividadeprofessor->professores_id}}</td>
                                    <td>{{$atividadeprofessor->professores_id}}</td>
                                    <td>{{$atividadeprofessor->created_at->format('d/m/Y H:i:s')}}</td>
                                </tr>
                                @empty
                                <tr colspan="2"></tr>
                                @endforelse
