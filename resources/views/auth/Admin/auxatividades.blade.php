        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('auxatividades.index')}}" class="nav-item nav-link active"></i>Atividades dos
                        auxiliares</a>
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                @forelse ($atividadeauxiliares as $atividadeauxiliar)
                                <tr>
                                    <td>{{$atividadeauxiliar->id}}</td>
                                    <td>{{$atividadeauxiliar->nome}}</td>
                                    <td>{{$atividadeauxiliar->auxiliares_id}}</td>
                                    <td>{{$atividadeauxiliar->auxiliares_id}}</td>
                                    <td>{{$atividadeauxiliar->created_at->format('d/m/Y H:i:s')}}</td>
                                </tr>
                                @empty
                                <tr colspan="2"></tr>
                                @endforelse
