    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('aljogos.index')}}" class="nav-item nav-link active"></i>Jogos dos alunos</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Jogos recentes dos alunos</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                @forelse ($jogoalunos as $jogoaluno)
                                <tr>
                                    <td>{{$jogoaluno->id}}</td>
                                    <td>{{$jogoaluno->nome}}</td>
                                    <td>{{$jogoaluno->alunos_id}}</td>
                                    <td>{{$jogoaluno->alunos_id}}</td>
                                    <td>{{$jogoaluno->created_at->format('d/m/Y H:i:s') }}</td>
