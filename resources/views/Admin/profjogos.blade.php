        ...
        <div class="pb-3 sidebar pe-4">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{route('admin.index')}}" class="nav-item nav-link active"></i>Atividades dos alunos</a>
                    ...
                    <a href="{{route('profatividades.index')}}" class="nav-item nav-link "></i>Atividades dos
                        professores</a>
                    <a href="{{route('profjogos.index')}}" class="nav-item nav-link active"></i>Jogos dos
                        professores</a>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="p-4 text-center rounded bg-light">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <h6 class="mb-0">Woldwide Sales</h6>
                            </div>
                ...
                <div class="p-4 text-center rounded bg-light">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                @forelse ($jogosprofessores as $jogosprofessor)
                                <tr>
                                    <td>{{$jogosprofessor->id}}</td>
                                    <td>{{$jogosprofessor->nome}}</td>
                                    <td>{{$jogosprofessor->professores_id}}</td>
                                    <td>{{$jogosprofessor->professores_id}}</td>
                                    <td>{{$jogosprofessor->created_at->format('d/m/Y H:i:s')}}</td>
