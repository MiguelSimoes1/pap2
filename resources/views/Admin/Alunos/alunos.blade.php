    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$aluno->numProcesso}}</td>
                                    <td>{{$aluno->nome}}</td>
                                    <td>{{$aluno->idade}}</td>
                                    <td>{{$aluno->email}}</td>
                                    <td>
                                        <a href="{{route('alunodb.edit', $aluno->id)}}"
                                            class="btn btn-warning btn-sm">  Editar  </a>
                                    </td>
                                    <td>
                                        <form action="{{route('alunodb.destroy', $aluno->id)}}" method="POST">
                                            @method('delete')
                                            @csrf
                ...
                <a href="{{route('alunodb.create')}}">Adicionar aluno</a>
            </div>
            <!-- Recent Sales End -->
