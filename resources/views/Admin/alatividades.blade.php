                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                @forelse ($atividadealunos as $atividadealuno)
                                    <tr>
                                        <td>{{ $atividadealuno->id }}</td>
                                        <td>{{ $atividadealuno->nome }}</td>
                                        <td>{{ $atividadealuno->alunos->numProcesso }}</td>
                                        <td>{{ $atividadealuno->alunos->nome }}</td>
                                        <td>{{ $atividadealuno->created_at->format('d/m/Y H:i:s') }}</td>
