            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('auxiliaresdb.index')}}" class="nav-item nav-link "></i>Lista de
                        auxiliares</a>
                    <a href="{{route('administrador.index')}}" class="nav-item nav-link active"></i>Lista de
                        administradores</a>
                </div>
            </nav>
        </div>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <form method="POST" action="{{route('administrador.update', $userlogin->id)}}">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nome</label>
                            <input type="string" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" min="10000" max="50000" name="nome" value="{{$userlogin->nome}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Password</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="password" value="{{$userlogin->palavrapasse}}">
                        </div>
