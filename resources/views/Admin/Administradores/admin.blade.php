    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('auxiliaresdb.index')}}" class="nav-item nav-link "></i>Lista de
                        auxiliares</a>
                    <a href="{{route('administrador.index')}}" class="nav-item nav-link active"></i>Lista de administradores</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                @forelse ($userslogin as $userlogin)
                                <tr>
                                    <td>{{$userlogin->nome}}</td>
                                    <td>{{$userlogin->palavrapasse}}</td>
                                    <td>
                                        <a href="{{route('administrador.edit', $userlogin->id)}}"
                                            class="btn btn-warning btn-sm">  Editar  </a>
                                    </td>
                                    <td>
                                        <form action="{{route('administrador.destroy', $userlogin->id)}}" method="POST">
                                            @method('delete')
                                            @csrf
                ...
                <a href="{{route('administrador.create')}}">Adicionar Administrador</a>
            </div>
            <!-- Recent Sales End -->
