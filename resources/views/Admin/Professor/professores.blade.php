    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$professor->numProcesso}}</td>
                                    <td>{{$professor->nome}}</td>
                                    <td>{{$professor->idade}}</td>
                                    <td>{{$professor->email}}</td>
                                    <td>
                                        <a href="{{route('professoresdb.edit', $professor->id)}}"
                                            class="btn btn-warning btn-sm">  Editar  </a>
                                    </td>
                                    <td>
                                        <form action="{{route('professoresdb.destroy', $professor->id)}}" method="POST">
                                            @method('delete')
                                            @csrf
                ...
                <a href="{{route('professoresdb.create')}}">Adicionar Professor</a>
            </div>
            <!-- Recent Sales End -->
