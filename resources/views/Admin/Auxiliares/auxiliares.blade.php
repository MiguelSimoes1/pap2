            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Lista de auxiliar</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$auxiliar->numProcesso}}</td>
                                    <td>{{$auxiliar->nome}}</td>
                                    <td>{{$auxiliar->idade}}</td>
                                    <td>{{$auxiliar->email}}</td>
                                    <td>
                                        <a href="{{route('auxiliaresdb.edit', $auxiliar->id)}}"
                                            class="btn btn-warning btn-sm">  Editar  </a>
                                    </td>
                                    <td>
                                        <form action="{{route('auxiliaresdb.destroy', $auxiliar->id)}}" method="POST">
                                            @method('delete')
                                            @csrf
                ...
                <a href="{{route('auxiliaresdb.create')}}">Adicionar Auxiliar</a>
            </div>
            <!-- Recent Sales End -->
