...
class AuxAtividadesController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $nomeMaisRepetido = DB::table('auxiliares_atividades')
        ...
        $menos_repetido = DB::table('auxiliares_atividades')
        ->select('nome', DB::raw('COUNT(*) as quantidade'))
        ->groupBy('nome')
        ->orderByDesc('quantidade')
        ->value('nome');
        ...
        $numRegistos = DB::table('auxiliares_atividades')->count();

        $Periodo = "";

        $manha = AuxiliaresAtividades::whereBetween('created_at', [
        ...
        $tarde = AuxiliaresAtividades::whereBetween('created_at', [
        ...
        $atividadeauxiliares = AuxiliaresAtividades::all();
        return view('Admin.auxatividades', [
            'atividadeauxiliares' => $atividadeauxiliares,
